...
export default function AboutSection() {
  return (
    <AboutStyles className="sections" id="about">
      ...
      <Features>
        ...
        <Box>
          ...
          <h3>Any style</h3>
          <p>
            Masters work in different styles - blackworks, watercolor,
        ...
        <Box>
          ...
          <p>
            Tattoo artistis are tested and certified - you are in safe hands.
          </p>
        </Box>
        <Box>
          ...
          <p>
            You can leave reviews and photos in the application - see the
            tattoos of other users and choose your master.
          </p>
        </Box>
      </Features>
    </AboutStyles>
